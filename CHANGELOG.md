...
- 逐项明细见计划文档：已归档到 `_trash_2026-09-10/superpowers_plans/2026-08-24-p1-bug-fixes.md`
...
- **未动**：KB 近邻指纹、切分窄化算法、协议探测回退等高成本项；逐项明细见计划文档：已归档到 `_trash_2026-09-10/superpowers_plans/2026-08-24-p2p3-batch-fixes.md`
